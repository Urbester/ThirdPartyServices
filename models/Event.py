...
class Event(db.Model):
    ...
    accepted = db.relationship("User", secondary=User_Accepted_Event, backref=db.backref('accepted_event', lazy='dynamic'))
    rejected = db.relationship("User", secondary=User_Rejected_Event, backref=db.backref('rejected_event', lazy='dynamic'))
    invited = db.relationship("User", secondary=User_InvitedTo_Event, backref=db.backref('invited_event', lazy='dynamic'))
